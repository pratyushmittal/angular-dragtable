angular.module('dragtable', []).value('mode', 'extension').value('version', 'v0.1.0').directive('draggable', [
  function() {
    ...
    return link = function(scope, element, attrs) {
      var absolutePosition, arForEach, dragEnd, dragMove, dragStart, eventPosition, findColumn, findUp, fnForEach, forEach, fullCopy, headers, i, k, len, moveColumn, ref, strForEach;
